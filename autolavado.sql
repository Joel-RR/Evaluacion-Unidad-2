...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2022 a las 21:33:56
...
(1, 'jose', 'perez', 'ramirez', 'las azaleas', '7641168552', 'jose@gmail.com', '2022-03-25', 1, NULL, NULL);
...
(1, 'De encerado', 200, 1, '2022-03-25', NULL, NULL);
...
(1, 'raul', 'gomez', 'gutierrez', 'la ribera', '7641168546', 'raul@gmail.com', 'Lavador', 1, '123456789', NULL, NULL);
...
(1, 'joel', 'joel@gmail.com', NULL, '$2y$10$jSnL80bOfPCOENVnZ.pJYuo4UUPmdEDgoti7ZmwrvMXiEUAMFVKki', NULL, '2022-03-26 00:26:35', '2022-03-26 00:26:35');
...
(1, 'EF-37-238', 'Particular', 'Nissan', 1177, 'verde', 4, 1, 1, '2022-03-25', NULL, NULL);
...
(1, '2022-03-25', 0, 0, 0, 1, NULL, NULL);
...
--
ALTER TABLE `servicios`
  MODIFY `id_servicios` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `trabajadores`
--
ALTER TABLE `trabajadores`
  MODIFY `id_trabajador` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `vehiculos`
  MODIFY `id_vehiculo` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `ventas`
--
ALTER TABLE `ventas`
  MODIFY `id_ventas` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
('root', '[{\"db\":\"autolavado\",\"table\":\"vehiculos\"},{\"db\":\"autolavado\",\"table\":\"clientes\"},{\"db\":\"autolavado\",\"table\":\"ventas\"},{\"db\":\"autolavado\",\"table\":\"trabajadores\"},{\"db\":\"autolavado\",\"table\":\"servicios\"}]');
...
('root', '2022-03-25 19:54:03', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
